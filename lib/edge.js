...
module.exports = function(decl, top, right, bottom, left) {
  ...
  const res = [];
  if (t) res.push({ prop: `top`, value: t, source: decl.source });
  if (r) res.push({ prop: `right`, value: r, source: decl.source });
  if (b) res.push({ prop: `bottom`, value: b, source: decl.source });
  if (l) res.push({ prop: `left`, value: l, source: decl.source });
